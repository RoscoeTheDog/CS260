...
int main(int argc, const char *argv[]) {
...
#ifdef TEST_THINK
	/*for the thinking test, I am allowing a boolean which tells the method if it is to be "simplified" notation
	it will call a seperate helper which builds the stack slightly different so that it only includes parenthesis for addition or subtraction*/
	...
	std::cout << "In Order should be (A+B)*C+D*F/G and is " << ptree4.inOrder(true) << std::endl << std::endl;
	...
	std::cout << "Input is A*B+(C-D)" << std::endl;
	std::cout << "In Order should be A*B+C-D and is " << ptree4.inOrder(true) << std::endl << std::endl;
	...
	std::cout << "for the thinking test, I am allowing a boolean which tells the method if it is to be \"simplified\" notation"
	             " it will call a seperate helper which builds the stack slightly different so that it only includes parenthesis for addition or subtraction" << std::endl;
